...
| CC-035 | Parts list column layout — resizable splitter and height-constrained scroll | Backlog | P2 |
| CC-036 | Anatomical limb parent validation (Hand parent must be an Arm, Foot parent must be a Leg) | Backlog | P2 |
