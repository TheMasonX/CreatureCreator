#!/usr/bin/env pwsh
# Import-OpenTasksFromWorkbench.ps1
# Adapted from MemorySmith\Scripts\Import-OpenTasksFromWorkbench.ps1.
#
# Reads the "Open" rows under "## Current Priorities" in
# Data/Pages/workbench/tasks.md and writes canonical MemorySmith task records
# to Data/Tasks/tsk-####-slug.json, plus activity events to
# Data/Events/tasks.activity.jsonl.
#
# NOTE: This is the seed importer. The CC-093 mass-import phase will extend
# this pattern to pipe existing docs/tasks/ markdown tickets into the
# MemorySmith service via its MCP/bridge task tools.
